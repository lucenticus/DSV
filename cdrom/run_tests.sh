...
cc -E cdrom.c -D__KERNEL__ -DMODULE -I/usr/src/linux/include -I/usr/src/linux-headers/include/ -I/usr/src/linux-headers/arch/x86/include/ -I/usr/src/linux-headers-`uname -r`/include/ > cdrom.c.preprocess
